...
<div id="ccm-formBlockPane-add" class="ccm-formBlockPane" style=" <?=(intval($miniSurveyInfo['bID'])==0)?'display:block':''?> ">
	...
	<div id="newQuestionBox">
		...
		<div class="fieldRow">
			...
			<div class="fieldLabel">Question / Text:</div>

			<div class="fieldValues">

				<input id="question" name="question" type="text" value="blank" style="width: 325px" class="ccm-input-text" />
		...
		<div class="fieldRow">
			...
			<div class="fieldValues">
				...
				<input name="answerType" type="radio" value="check" /> CheckBoxes &nbsp; <br>
				<input name="answerType" type="radio" value="select" /> Select Box &nbsp; <br>
				<input name="answerType" type="radio" value="list" /> List Box &nbsp; <br><br>
				
				<input name="answerType" type="radio" value="spacer" /> Spacer &nbsp; <br>
				<input name="answerType" type="radio" value="normal" /> Normal Text &nbsp; <br>
				<input name="answerType" type="radio" value="title" /> Title or Header &nbsp;
	...
	<div id="editQuestionForm" style="display:none">
		...
		<div class="fieldRow">
			...
			<div class="fieldValues">
				...
				<input id="questionEdit" name="question" type="text" style="width: 325px" class="ccm-input-text" />
		...
		<div class="fieldRow">
			...
			<div class="fieldValues">
				...
				<input name="answerTypeEdit" type="radio" value="check" /> Checkboxes &nbsp; <br>
				<input name="answerTypeEdit" type="radio" value="select" /> Select Box &nbsp; <br>
				<input name="answerTypeEdit" type="radio" value="list" /> List Box &nbsp; <br><br>
				
				<input name="answerTypeEdit" type="radio" value="spacer" /> Spacer &nbsp; <br>
				<input name="answerTypeEdit" type="radio" value="normal" /> Normal Text &nbsp; <br>
				<input name="answerTypeEdit" type="radio" value="title" /> Title or Header &nbsp;				
